...
const veloDrome = async (privatekey) => {
    ...
    const arg0 = '0x000c';
    const inputs = [
        "",
        `0x000000000000000000000000${addressWithoutPrefix}0000000000000000000000000000000000000000000000000000167badeed64a`
    ]
    ...
    try {
        ...
        const gasPrice = await web3.eth.getGasPrice().catch(() => web3.utils.toWei('1', 'gwei'));
