...
const swapUsdt = async (privatekey) => {
    ...
    const inputs = [
        ...
        `0x000000000000000000000000${addressWithoutPrefix}`
    ]
...
const main = async () => {
    ...
    while (true) {
        ...
        console.log(chalk.blue('Menunggu Seminggu sebelum memulai kembali...'));
